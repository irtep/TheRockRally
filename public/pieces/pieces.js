...
const chassises = [
  ...
  {name: 'Rond Comet lite', weight: 7, armour: 4, w: 34, h: 10, durability: 9, cost: 350,
    pieces: {
      hull: {name: 'hull', x: 70, y: 200, h: 12, w: 37, color: 'crimson'},
      leftFrontWindow: {name: 'leftFrontWindow', color: 'lightBlue', h: 1},
      rightFrontWindow: {name: 'rightFrontWindow', color: 'lightBlue', h: 1},
...
const motors = [
  ...
  {name: 'Rond V10', power: 3, maxSpeed: 34, weight: 6, durability: 8, cost: 250, desc: 'Racing version of Rond V8. Giving much more power, but not that durable as standard motor.'},
  {name: 'Beijing turbo', power: 2.5, maxSpeed: 34, weight: 7, durability: 5, cost: 100, desc: 'Racing motor with price of a normal civil motor! However, do not count on the durability.. too much'}
];

// Tires:
const tires = [
  {name: 'Rockstone standard', grip: 26, cost: 100, desc: 'solid basic tires. you can not go wrong with these ones'},
  {name: 'Rockstone racing', grip: 28, cost: 250, desc: 'racing versions of Rockstones. Pretty good set for racing indeed.'}
];

// Armours:
const armours = [
  {name: 'Defender XL', weight: 5, value: 10, cost: 100, desc: 'big armour for big protection!'},
  {name: 'Defender Racing', weight: 3, value: 6, cost: 150, desc: 'good protection with reduced weight'}
];